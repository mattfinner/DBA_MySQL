...
# Create cron job
crontab -u mysql -l | { cat; echo "0 0 * * * /data/mysql/scripts/backupWithCompression.sh > /data/mysql/logs/backupWithCompression.log 2>&1"; } | crontab -u mysql -
crontab -u mysql -l | { cat; echo "59 23 * * * /data/mysql/scripts/purgeBackupWithCompressionJobLog.sh"; } | crontab -u mysql -
